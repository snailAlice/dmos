...
remotecmd "wget https://github.com/fanux/dmos/releases/download/v3.0.1/dmos && chmod +x dmos && mv dmos /usr/bin"

version=$1
pkgurl=$2

echo "./sshcmd dmos command"
remotecmd "dmos init --master $master0 --master $master1 --master $master2 \
...
echo "./sshcmd dmos clean command"
remotecmd "dmos clean --master $master0 --master $master1 --master $master2 \
