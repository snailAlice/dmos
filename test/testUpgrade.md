...
```
dmos upgrade --version v1.19.2 --pkg-url kube1.19.2.tar.gz
```
# 声明
...
目前版本是v1.19.2 ,需要升级只 v1.19.1. dmos 拒绝升级
<details><summary><code>upgrade logs </code> Output</summary><br><pre>

```
[root@dev-k8s-master ~]# ./dmos upgrade  --pkg-url kube1.19.1.tar.gz --version v1.19.1 
...
[root@dev-k8s-master ~]# ./dmos upgrade  --pkg-url kube1.17.12.tar.gz --version v1.17.12  -f
...
两个master。目前版本是v1.19.1 ,需要升级至 v1.19.2. dmos 可以升级
<details><summary><code>upgrade  logs </code> Output</summary><br><pre>

```
dmos upgrade  --pkg-url kube1.19.2.tar.gz --version v1.19.2 -f 
...
16:09:19 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.19.2.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
16:09:19 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.19.2.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
17:02:33 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.19.2.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
17:02:35 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.19.2.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
$ dmos  upgrade  --pkg-url /root/kube1.18.3.tar.gz  --version v1.18.3 -f | tee -a upgrade.1180-1183.log 
...
19:49:48 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
19:49:49 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
19:49:49 [INFO] [ssh.go:50] [192.168.160.244:22] kube/
19:49:49 [INFO] [ssh.go:50] [192.168.160.243:22] kube/
19:49:50 [INFO] [ssh.go:50] [192.168.160.244:22] kube/bin/dmos
19:49:50 [INFO] [ssh.go:50] [192.168.160.243:22] kube/bin/dmos
...
```
$ dmos upgrade --version v1.17.12 --pkg-url /root/kube1.17.12.tar.gz -f | tee -a upgrade.11610-11712.log
...
20:10:06 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.17.12.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
20:10:23 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.17.12.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
## test case 7
1主1从，目前版本是v1.17.12 ,需要升级至 v1.18.3. dmos 可以升级
<details><summary><code>upgrade logs </code> Output</summary><br><pre>
...
[root@dev-k8s-master ~]# dmos  upgrade --version v1.18.3 --pkg-url /root/kube1.18.3.tar.gz  -f |tee -a upgrade.11712-1183.log
...
23:51:57 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
23:51:57 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
23:51:58 [INFO] [ssh.go:50] [192.168.160.243:22] kube/bin/dmos
23:51:58 [INFO] [ssh.go:50] [192.168.160.244:22] kube/bin/dmos
...
1.19.2.new.log   Desktop           httpbin.yaml                    kube1.18.0.tar.gz      LICENSE              Pictures              testdmos.sh
...
as.log           Downloads         istio-1.6.8                     kube1.19.1.tar.gz.bak  manifests            dmos                upgrade.11712-1192.log
a.txt            etcd-config.yaml  istio-1.6.8-linux-amd64.tar.gz  kube1.19.2.tar.gz      Music                dmos.bak            upgrade.1180-1183.log
azk8s.sh         go                istio.yaml                      kubeadm                new.yaml             dmos.latest         Videos
...
## test case 9
1 master 2 worker . 目前版本是v1.16.10 ,需要升级至 v1.17.12. dmos 可以升级. 
<details><summary><code>upgrade logs </code> Output</summary><br><pre>

安装

```
$ dmos init --master 192.168.160.243  --pkg-url /root/kube1.16.10.tar.gz --version v1.16.10  --passwd centos  --node 192.168.160.244 --node 192.168.160.245 | tee -a install.16.10.log
...
```
 dmos upgrade --version v1.17.12 --pkg-url /root/kube1.17.12.tar.gz -f | tee -a upgrade.onemastertwonode.11610-11712.log 
...
## test case 10
3 master . 目前版本是v1.17.12 ,需要升级至 v1.18.3. dmos 可以升级. 
<details><summary><code>upgrade logs </code> Output</summary><br><pre>
...
```
 dmos  upgrade --version v1.18.3 --pkg-url /root/kube1.18.3.tar.gz  -f | tee -a upgrade.threemaster.11712-1183.log
...
13:42:53 [INFO] [ssh.go:57] [ssh][192.168.160.244:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
13:42:55 [INFO] [ssh.go:50] [192.168.160.244:22] kube/
13:43:00 [INFO] [ssh.go:50] [192.168.160.244:22] kube/bin/dmos
...
13:43:49 [INFO] [ssh.go:57] [ssh][192.168.160.243:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
13:44:03 [INFO] [ssh.go:50] [192.168.160.243:22] kube/bin/dmos
...
13:48:31 [INFO] [ssh.go:57] [ssh][192.168.160.245:22] cd /root && rm -rf kube && tar zxvf kube1.18.3.tar.gz  && cd /root/kube/shell && rm -f ../bin/dmos && (docker load -i ../images/images.tar || ture) && cp -f ../bin/* /usr/bin/ 
...
13:48:46 [INFO] [ssh.go:50] [192.168.160.245:22] kube/bin/dmos
