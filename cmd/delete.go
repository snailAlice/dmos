...
import (
	...
	//"github.com/fanux/dmos/install"
)

var (
	deleteExamlpe = `
	# delete from default config in installed tar
	dmos delete --pkg-url mysql.tar 

	# delete from your define config when dmos install use 
	dmos delete --pkg-url mysql.tar -c /root/config -w /data/

	# delete force no interactive
	dmos delete --pkg-url mysql.tar -f
`
)
...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "delete kubernetes apps installled by dmos..",
	Long: `delete kubernetes apps, like dashboard prometheus installled by dmos.. 
`,
