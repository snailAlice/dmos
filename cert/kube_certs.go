...
var (
	DmosConfigDir         = GetUserHomeDir() + "/.Dmos"
...
func NewDmosCertMetaData(certPATH, certEtcdPATH string, apiServerIPAndDomains []string, SvcCIDR, nodeName, nodeIP, DNSDomain string) (*DmosCertMetaData, error) {
	data := &DmosCertMetaData{}
...
func (meta *DmosCertMetaData) apiServerAltName(certList *[]Config) {
...
func (meta *DmosCertMetaData) etcdAltAndCommonName(certList *[]Config) {
	altname := AltNames{
		DNSNames: map[string]string{
			"localhost":   "localhost",
...
func (meta *DmosCertMetaData) generatorServiceAccountKeyPaire() error {
	dir := meta.CertPath
...
func (meta *DmosCertMetaData) GenerateAll() error {
